...
export const SEO: React.FC<SEOProps> = ({
  ...
  keywords = `car rental in udaipur, best taxi service in udaipur, luxury taxi service in udaipur, cab service in udaipur, udaipur taxi service, best travel agency in udaipur, travel agency in udaipur, 077280 96547, 07728096547, 7728096547, +917728096547, udaipur local sightseeing taxi, innova crysta taxi in udaipur, tempo traveller in udaipur, udaipur airport cab service, udaipur to mount abu cab, udaipur to jodhpur taxi, rajasthan tour packages, cab booking udaipur, tourist taxi udaipur`,
