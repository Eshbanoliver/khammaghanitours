...
import { Compass, ArrowRight, Star, ShieldCheck, Sparkles, Car, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="max-w-4xl space-y-8 text-left">
          ...
          <motion.div
            ...
            className="pt-4 flex flex-wrap items-center gap-6 text-xs sm:text-sm font-semibold text-slate-400"
          >
