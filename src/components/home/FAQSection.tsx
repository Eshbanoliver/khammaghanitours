...
import { ChevronDown, HelpCircle, MessageCircle, PhoneCall, Sparkles, CheckCircle2 } from 'lucide-react';
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto shrink-0">
            <a
              ...
              className="w-full sm:w-auto px-6 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-xs uppercase tracking-wider rounded-2xl shadow-lg flex items-center justify-center gap-2 transition-all hover:scale-105 active:scale-95"
            >
